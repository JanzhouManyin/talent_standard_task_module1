...
const formValid = function (formErrors, ...rest) {
    ...
    if (formErrors.description.length > 0 || formErrors.summary.length > 0) {
        valid = false;
    }
    return valid;
};
...
export default class SelfIntroduction extends React.Component {
    ...
    handleChange(e) {
        ...
        switch (name) {
            case "summary":
                if (value.length == 0) {
                    formErrors.summary = "summary cannot be null";
                } else {
                    formErrors.summary = "";
                }
                break;
            case "description":
                if (value.length == 0) {
                    formErrors.description = "description cannot be null";
                } else {
    ...
    openEdit() {
        ...
        const description = this.props.descriptionData.description;
        const summary = this.props.descriptionData.summary;
        let formErrors = this.state.formErrors;
        ...
        if (description.length == 0) {
            formErrors.description = "summary cannot be null";
        } else {
            formErrors.description = "";
        }
    ...
    renderDisplay() {
        ...
        let description = this.props.descriptionData ? this.props.descriptionData.description : ""
        let summary = this.props.descriptionData ? this.props.descriptionData.summary : "";
        return (
            <React.Fragment>
                <div className="four wide column">
                    <h3>description</h3>
