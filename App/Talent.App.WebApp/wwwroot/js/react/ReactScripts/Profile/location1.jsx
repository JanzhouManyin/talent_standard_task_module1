...
const locations = [
    {
        country: "Afghanistan", cities: ["Herat",
            "Kabul",
            "Kandahar",
            "Molah",
            "Rana",
    ...
    {
        country: "Albania", cities: ["Elbasan",
            "Petran",
            "Pogradec",
            "Shkoder",
            "Tirana",
...
export class Address extends React.Component {
    ...
    renderEdit() {
        ...
        console.log("renderEditpostCode");
        console.log(postCode);
...
export class Nationality extends React.Component {
    ...
    openEdit() {
        ...
        console.log(this.props.nationalityData)
